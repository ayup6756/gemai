...
class Config(BaseModel):
    ...
    agent_info_prompt: str = (
        "You are master of worker agent and each agent does something. you can use these agents do to things you can't do yourself. These agent will respond as role model.\n"
        ...
        "It will generate an image, it would output as role model, don't call it again after its done\n\n"
